...
public class MongoMigrations(MongoContext context, IHostEnvironment env)
{
    ...
    public async Task RunMigrationsAsync()
    {
        ...
        if (ownersCount == 0)
        {
            var seedOwners = new[]
            {
                new Owner { Name = "John Doe", Address = "123 Main St", Photo = "https://plus.unsplash.com/premium_photo-1666298858421-3765c17bcf80?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", Birthday = new DateTime(1985, 5, 15) },
                new Owner { Name = "Jane Smith", Address = "456 Oak Ave", Photo = "https://images.unsplash.com/photo-1531891437562-4301cf35b7e4?q=80&w=928&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", Birthday = new DateTime(1990, 8, 20) }
            };
        ...
        if (await _context.PropertyImages.CountDocumentsAsync(FilterDefinition<PropertyImage>.Empty) == 0)
        {
            ...
            {
                new() { IdProperty = propertiesList[0].Id!, File = "https://images.unsplash.com/photo-1480074568708-e7b720bb3f09?q=80&w=1748&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", Enabled = true },
                new() { IdProperty = propertiesList[1].Id!, File = "https://plus.unsplash.com/premium_photo-1689609950112-d66095626efb?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", Enabled = true }
            };
